...
- [ ] **[UI stories only]** Verify in browser using Selenium MCP
```

**Important:** 
- Acceptance criteria must be verifiable, not vague. "Works correctly" is bad. "Button shows confirmation dialog before deleting" is good.
- **For any story with UI changes:** Always include "Verify in browser using Selenium MCP" as acceptance criteria. This ensures visual verification of frontend work.
